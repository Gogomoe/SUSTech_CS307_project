_12307.admin.api = {
    ...
    remove_train_static: function (train_static_id, cb_ok = this.default_cb_ok, cb_err = this.default_cb_err) {
        var request_url = this.url + "train/static/" + train_static_id;
        dhx.ajax.delete(request_url).then(cb_ok).catch(cb_err);
    },
    ...
    get_train_static: function (train_static_id, cb_ok = this.default_cb_ok, cb_err = this.default_cb_err) {
        var request_url = this.url + "train/static/" + train_static_id + "/trainline";
